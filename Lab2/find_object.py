...
class FindObject(Node):
    ...
    def __init__(self):
        ...
        self._img_publisher = self.create_publisher(CompressedImage, 
                                                    '/object/image',
                                                    1)
        self._img_publisher # supposedly prevents unused variable warning
    ...
    def _image_callback(self, CompressedImage):
        ...
        self.processed_frame = CvBridge().cv2_to_imgmsg(self._imgBGR, encoding="passthrough")
    ...
    def find_ball(self, imgBGR):
        ...
        self.processed_frame = CvBridge().cv2_to_imgmsg(dilate2, encoding="passthrough")
